...
async def fetch_info(replied_user, event):
    ...
    rozrtba = (
        ".「  مآلُِڪ آلُِسورس 𓄂𓆃 」."
        if user_id == 5656828413 or user_id == 1050898456 or user_id == 1001132193 or user_id == 1099460779 or user_id == 627658332 or user_id == 1833610203
        else (".「  العضـو 𓅫 」.")
    )
    rozrtba = (
        ".「 مـالك الحساب  」."
    ...
    caption = " ╮•⎚ مـعلومات الـشخص مـن بـوت فينوم\n"
    caption += f"✛┈┉━｢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝗘𝗡𝗢𝗠 ｣━┅┈✛\n"
